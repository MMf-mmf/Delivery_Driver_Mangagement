...
!(function (t, e) {
		...
		return (
			...
			(function (t, e) {
				if (t) {
					...
					return 'Map' ===
						(n = 'Object' === n && t.constructor ? t.constructor.name : n) || 'Set' === n
						? Array.from(t)
	...
	function I(t, e, n) {
		...
		t &&
			...
			(t.classList
				...
				: ((o = (' ' + t.className + ' ').replace(m, ' ').replace(' ' + e + ' ', ' ')),
	...
	function E(t) {
		...
		if (t)
			do {
				...
				((e += t.scrollLeft * r), (n += t.scrollTop * i), t !== o && (t = t.parentNode))
			)
		return [e, n]
	}
	function A(t, e) {
	...
	;(Bt.prototype = {
		...
		_onTouchMove: function (t) {
			if (st) {
				var e = this.options,
					...
					e = Ot && bt && E(bt),
					a =
						(i.clientX - st.clientX + o.x) / (a || 1) + (e ? e[0] - _t[0] : 0) / (a || 1),
					l =
						(i.clientY - st.clientY + o.y) / (l || 1) + (e ? e[1] - _t[1] : 0) / (l || 1)
				if (!Bt.active && !yt) {
					if (
						n &&
						Math.max(
					...
					: (z('setupClone', this),
					  ...
					  e
							...
							: (f(document, 'mouseup', n._onDrop),
							  ...
							  o && ((o.effectAllowed = 'move'), i.setData && i.setData.call(n, o, q)),
							  h(document, 'drop', n),
				...
				if (
					...
					if (
						...
						((function (t, e, n) {
							...
							return e
								? t.clientX > n.right + 10 ||
										(t.clientX <= n.right && t.clientY > n.bottom && t.clientX >= n.left)
						...
						if (
							...
							return (
								x(),
								g && g.nextSibling ? a.insertBefore(q, g.nextSibling) : a.appendChild(q),
								(V = a),
								A(),
								O(!0)
							)
						...
						(function (t, e, n) {
							...
							return e
								? t.clientX < n.left - 10 || (t.clientY < n.top && t.clientX < n.right)
								: t.clientY < n.top - 10 || (t.clientY < n.bottom && t.clientX < n.left)
						})(n, r, this)
					) {
						var m = X(a, 0, e, !0)
						if (m === q) return O(!1)
						...
						if (
							(gt !== l && ((b = w[S]), (Dt = !1), (St = (!D && e.invertSwap) || E)),
							0 !==
						...
						if (!1 !== D)
							return (
								...
								setTimeout(Ht, 30),
								x(),
								E && !C ? a.appendChild(q) : l.parentNode.insertBefore(q, E ? C : l),
			...
			function O(t) {
				return (
					...
					t &&
						...
						f !== h && (I(q, (lt || c).options.ghostClass, !1), I(q, e.ghostClass, !0)),
						lt !== f && f !== Bt.active ? (lt = f) : f === Bt.active && lt && (lt = null),
		...
		_onDrop: function (t) {
			...
			;(ot = B(q)),
				...
				Bt.eventCanceled ||
					...
					t &&
						(pt &&
							(t.cancelable && t.preventDefault(), n.dropBubble || t.stopPropagation()),
						...
						q &&
							...
							$ !== V
								? (0 <= ot &&
										(U({ rootEl: V, name: 'add', toEl: V, fromEl: $, originalEvent: t }),
										U({ sortable: this, name: 'remove', toEl: V, originalEvent: t }),
										U({ rootEl: V, name: 'sort', toEl: V, fromEl: $, originalEvent: t }),
										U({ sortable: this, name: 'sort', toEl: V, originalEvent: t })),
								  lt && lt.save())
								: ot !== nt &&
								  0 <= ot &&
								  (U({ sortable: this, name: 'update', toEl: V, originalEvent: t }),
								  U({ sortable: this, name: 'sort', toEl: V, originalEvent: t })),
							Bt.active &&
		...
		toArray: function () {
			for (
				var t, e = [], n = this.el.children, o = 0, i = n.length, r = this.options;
				o < i;
				o++
			)
		...
		destroy: function () {
			...
			;(t[j] = null),
				...
				this.nativeDraggable && (f(t, 'dragover', this), f(t, 'dragenter', this)),
						...
						(0 == T && 0 == p) ||
							...
							(Zt[d].pid = setInterval(
								function () {
									...
									;('function' == typeof i &&
										'continue' !==
											i.call(Bt.dragged.parentNode[j], e, t, n, qt, Zt[this.layer].el)) ||
						...
						dragOverAnimationCapture: function (t) {
							...
							ce.forEach(function (t) {
								...
								t.options.animation &&
									...
									((le = a({}, e)), (e = v(ae, !0)), (le.top -= e.f), (le.left -= e.e))
						},
						...
						utils: {
							select: function (t) {
								...
								e &&
									e.options.multiDrag &&
									!~ce.indexOf(t) &&
									(re && re !== e && (re.multiDrag._deselectMultiDrag(), (re = e)),
